...
def _build_statsimpact_scope_workbook(flt) -> Workbook:
    ...
    _append_section(ws_at, 'Vue ateliers', ['Secteur','Atelier','Type','Sessions prév.','Sessions réelles','Présences','Uniques','Heures réalisées',"Taux d'occupation (%)",'Moyenne / séance','Durée activité (j)'], atelier_rows, start_row=1)
...
def export_fidele_xlsx():
    ...
    return send_file(
        bio,
        as_attachment=True,
        download_name="statsimpact_export_fidele.xlsx",
