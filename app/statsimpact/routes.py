...
CSV_FIELD_GROUPS = [
    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "presence_dispositif_type", "label": "Dispositif"},
            {"key": "presence_accompagnant_nom", "label": "Accompagnant"},
            {"key": "presence_accompagnant_type", "label": "Type accompagnant"},
...
CSV_FIELD_MAP = {
    ...
    "presence_dispositif_type": {"label": "Dispositif", "getter": lambda ctx: ctx["presence"].dispositif_type or ""},
    "presence_accompagnant_nom": {"label": "Accompagnant", "getter": lambda ctx: ctx["presence"].accompagnant_nom or ""},
    "presence_accompagnant_type": {"label": "Type accompagnant", "getter": lambda ctx: ctx["presence"].accompagnant_type or ""},
    "presence_created_at": {
...
SENSITIVE_INSERTION_FIELDS = {
    ...
    "participant_cir_obtenu",
    "presence_dispositif_type",
    "presence_accompagnant_nom",
    "presence_accompagnant_type",
}
