...
class PresenceActivite(db.Model):
    ...
    dispositif_type = db.Column(db.String(120), nullable=True)
    accompagnant_nom = db.Column(db.String(180), nullable=True)
    accompagnant_type = db.Column(db.String(30), nullable=True)
